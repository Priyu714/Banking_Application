...
import com.webapp.banking_application.exception.AccountDoesNotExists;
import com.webapp.banking_application.exception.InvalidOTPException;
import com.webapp.banking_application.exception.OtpRetryLimitExceededException;
import org.springframework.beans.factory.annotation.Autowired;
import org.springframework.cache.Cache;
import org.springframework.cache.CacheManager;
import com.webapp.banking_application.entity.OtpInfo;
import com.webapp.banking_application.repository.otpInfoRepository;
...
public class OTPServiceImpl implements OTPService{
    ...
    private String generateNewOTP(String accountNumber){
        ...
        int otp_val =100_100 + random.nextInt(900_100);
        String otp =String.valueOf(otp_val);
    ...
    public CompletableFuture<Boolean> sendOTPByEmail(String email, String name, String accountNumber, String otp) {
        ...
        String emailText =emailService.getOtpLoginEmailTemplat(name,"xxx"+ accountNumber.substring(3),otp);
